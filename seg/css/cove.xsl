...
<xsl:template match="oxml:solicitarRecibirCoveServicio/oxml:comprobantes">
  ...
  <h3>Datos del comprobante</h3>
    <table align="center" BORDER="1" width="600" cellpadding="2" cellspacing="0">
      <tr>
        ...
        <td bgcolor="goldenrod">Relación de facturas</td><td>SIN RELACION DE FACTURAS</td>
      </tr>
      <tr>
        <td bgcolor="goldenrod">No. de factura</td><td><xsl:value-of select="oxml:numeroFacturaOriginal"/></td>
      ...
      <tr>
        <td bgcolor="goldenrod">Subdivisión</td><td><xsl:value-of select="oxml:factura/oxml:subdivision"/> </td>
        <td bgcolor="goldenrod">Certificado de origen</td><td><xsl:value-of select="oxml:factura/oxml:certificadoOrigen"/> </td>
      </tr>
      <tr>
        <td bgcolor="goldenrod">No. de exportador autorizado</td><td><xsl:value-of select="oxml:factura/oxml:numeroExportadorAutorizado"/></td>
  ...
  <h3>Datos del destinatario</h3>
    ...
    <h3>Mercancias</h3>
    <table align="center" border="1" width="950" cellpadding="2" cellspacing="0"> 
