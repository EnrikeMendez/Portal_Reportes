		...
		if UBound(Split(lista_correo(i), "@")) > 0 then
		   if LCase(Trim(Split(lista_correo(i), "@")(1))) = Get_Mail("logis_mx") or LCase(Trim(Split(lista_correo(i), "@")(1))) = "it-and-apps.mx" then
			 if LCase(Trim(Split(lista_correo(i), "@")(0))) <> "christelle" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "guillehe" _
			    ...
			    and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "crossdocktln" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "teresam"     and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "erikapm" and  LCase(Trim(Split(lista_correo(i), "@")(0))) <> "cedischihuahua" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "edgar.zacarias" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "liquidaciones_mty" then
		  ...
		  if LCase(Trim(Split(lista_correo(i), "@")(1))) = Get_Mail("logis_mx") or LCase(Trim(Split(lista_correo(i), "@")(1))) = "it-and-apps.mx" then
			if LCase(Trim(lista_correo(0))) <> "christelle" and LCase(Trim(lista_correo(0))) <> "guillehe" and LCase(Trim(lista_correo(0))) <> "jessica"  and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "crossdocktln" and LCase(Trim(lista_correo(0))) <> "cedischihuahua" and LCase(Trim(lista_correo(0))) <> "edgar.zacarias"  and LCase(Trim(lista_correo(0))) <> "liquidaciones_mty" then
