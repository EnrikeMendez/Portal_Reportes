...
*/
	function dynCalendar_show()
	{
        ...
        */
		...
		html = '<table border="0" bgcolor="#eeeeee" width=215>';
...
*/
	function dynCalendar_writeHTML()
	{
		if (is_ie5up || is_nav6up || is_gecko) {
			document.write(sprintf('<a href="javascript: %s.show()"><img src="%sdynCalendar.gif" alt="calendario" border="0" width="10" height="10" /></a>', this.objName, this.imagesPath));
			document.write(sprintf('<div class="dynCalendar" style="Z-INDEX: 101;" id="%s" onmouseover="%s._mouseover(true)" onmouseout="%s._mouseover(false)"></div>', this.layerID, this.objName, this.objName));
		}
	}
