...
function check_mail(correo)
	...
	for i = 0 to UBound(lista_correo)
		if UBound(Split(lista_correo(i), "@")) > 0 then
		   if LCase(Trim(Split(lista_correo(i), "@")(1))) = Get_Mail("logis_mx") or LCase(Trim(Split(lista_correo(i), "@")(1))) = "it-and-apps.mx"  or LCase(Trim(Split(lista_correo(i), "@")(1))) = "logis.com" then
			 if LCase(Trim(Split(lista_correo(i), "@")(0))) <> "christelle" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "guillehe" _
			    ...
			    and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "crossdocktln" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "teresam" _
			    and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "erikapm" and  LCase(Trim(Split(lista_correo(i), "@")(0))) <> "cedischihuahua" _
			    and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "edgar.zacarias" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "liquidaciones_mty" _
			    and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "rechazos_mty" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_loreal1" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_loreal2" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_loreal3" _ 
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_loreal4" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_gsk" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "adrianagmh" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo2" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "cedis_nuevolaredo" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_helvex" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo4" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo5" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "cedis_slp" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo3" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_gdl1" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo7" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "cedis_vsa" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo1" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "julioecv" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo2" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_gdl" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo6" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo10" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo3" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo4" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo5" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "cesarrp" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_gdl2" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "isaurohe" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_qro1" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "cedis_cdjuarez" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_loreal5" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo8" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "desarrollo_web" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo11" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo1" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo12" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo9" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo"  _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sistemas_logis_smo" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "citas_mid" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo6" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "almacen_gdl" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_gdl3" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "facturacion_smo" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "facturacion2_smo" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "facturacion3_smo" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "facturacion4_smo" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "facturacion5_smo" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "facturacion6_smo" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "facturacion7_smo" _
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "creditoycobranza_smo" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "creditoycobranza3_smo"_ 
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "creditoycobranza4_smo" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo14"_ 
				and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "sac_smo13" and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "evidencias_smo8" then	
		  ...
		  if LCase(Trim(Split(lista_correo(i), "@")(1))) = Get_Mail("logis_mx") or LCase(Trim(Split(lista_correo(i), "@")(1))) = "it-and-apps.mx" then
			if LCase(Trim(lista_correo(0))) <> "christelle" and LCase(Trim(lista_correo(0))) <> "guillehe" _ 
				and LCase(Trim(lista_correo(0))) <> "jessica"  and LCase(Trim(Split(lista_correo(i), "@")(0))) <> "crossdocktln" _ 
				and LCase(Trim(lista_correo(0))) <> "cedischihuahua" and LCase(Trim(lista_correo(0))) <> "edgar.zacarias"  _ 
				and LCase(Trim(lista_correo(0))) <> "liquidaciones_mty" and LCase(Trim(lista_correo(0))) <> "rechazos_mty" then
	...
	next
'<10/03/2022: Se eliminan validaciones del correo que se captura al generar un reporte desde "Reporte Anomalías" (correo { asunto: "RV: Descarga de KPI", de: "Julio Edgar Cortés Vital <julioecv@logis.com.mx>", fecha: "jueves 10/03/2022 01:44 p. m." } ):
	check_mail = ""
' 10/03/2022>
end function
...
function CatalogoPrioridadDinamica()
		...
		CatalogoPrioridadDinamica = ArrayPrioridadDinamica

end function

function EscribeLog(Texto)
	Dim NombreArchivo, Ruta, Fecha, Hora
	Dim FSO, File_IO
	...
	Ruta = "\\" & Trim(request.serverVariables("LOCAL_ADDR")) & "\reportes\web_reports\"
	NombreArchivo = Ruta & "AccesoPortalReportes_QA_" & Fecha & ".log"
	
'	SET FSO = Server.CreateObject("Scripting.FileSystemObject")
'	
'	If (FSO.FileExists(NombreArchivo))= false Then
'		Set File_IO = FSO.CreateTextFile(NombreArchivo, True)
'	Else
'		Set File_IO = FSO.OpenTextFile(NombreArchivo,8,true)
'	End If
'	
'	File_IO.WriteLine(Hora & " [" & SQLEscape(request.serverVariables("REMOTE_ADDR")) & "] " & Texto)
'	
'	File_IO.Close
	
	EscribeLog = NombreArchivo
end function
%>